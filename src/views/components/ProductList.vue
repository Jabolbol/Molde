    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <router-link class="btn btn-primary w-100" to="productCreate">+ Tambah</router-link>
          </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row justify-content-end">
                    <router-link class="btn btn-primary" :to="'productDetail/'+product.id">Detail</router-link>
                </div>
              </div>
            </div>
          </div>
